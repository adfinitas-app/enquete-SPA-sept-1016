...
function validateForm() {
	...
	$("body").append('<iframe src="http://orixamedia.go2cloud.org/SLHG?adv_sub=' + document.getElementById('f_email').value + '" scrolling="no" frameborder="0" width="1" height="1" style="display:none"></iframe>');
	display_results();
